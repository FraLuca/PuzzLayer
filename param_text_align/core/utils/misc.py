...
def parse_args():
    ...
    # parser.add_argument("--layer_list", type=list_of_strings, help="list of layers")
    parser.add_argument(
    ...
    cfg.NAME = "_".join(cfg.MODEL.LAYER_LIST)
    cfg.SAVE_DIR = cfg.OUTPUT_DIR # os.path.join(cfg.OUTPUT_DIR, cfg.NAME)
